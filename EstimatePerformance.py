...
class estimatePerformance:
    ...
    @classmethod
    def thresholding(cls,gt,threshold_list,score,thres_class=None,plot=False):
        ...
        for thres in threshold_list:
            ...
            cls().computating(gt,pred)
            indicators=cls().indicators(data_type='df',col_name=thres)
            df=pd.concat([df,indicators],axis=1)
        
        if plot==True:
            plotimage.plot_curve(
                xlabel='OK_recall',
